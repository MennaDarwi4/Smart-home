...
public class login extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "you should sign up first");
        }
        else if(atm.login(file,accNum, pinCode )){
            JOptionPane.showMessageDialog(null,"you loged in succefuly", "Report" , JOptionPane.INFORMATION_MESSAGE);
             Bank m = new Bank(accNum , pinCode);
             m.setVisible(true);
